...
# 设置基础目录和类别
base_dir = "/share/workspace/lixiang/HongyiLi/HongyiLi/ML/dataset/EATD-2classification"
...
# 创建保存结果的目录
output_dir = "/share/workspace/lixiang/HongyiLi/HongyiLi/ML/Qwen2-Audio-Embedding/2-Dep-Classification"
...
for spilt in spilts:
    ...
    for category in categories:
        ...
        if category_embeddings is not None:
            # 保存当前类别的嵌入
            category_output = os.path.join(output_dir, spilt)
            category_output_path = os.path.join(category_output, f"{category}_embeddings.npy")
